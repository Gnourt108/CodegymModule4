...
import DanhMucVatTu from './pages/vattu/DanhMucVatTu';
import NhapXuatKho from './pages/vattu/NhapXuatKho';
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            {/* --- Vật tư --- */}
            <Route path="/vat-tu/danh-muc" element={<DanhMucVatTu />} />
            <Route path="/vat-tu/nhap-xuat" element={<NhapXuatKho />} />
